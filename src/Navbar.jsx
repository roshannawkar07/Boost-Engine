...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 flex justify-between bg-stone-950 text-white py-5 px-8 md:sticky-top-0-z-50">
      <div className="logo">
      ...
      {isMenuOpen && (
        <ul className="absolute top-0 left-0 w-full bg-stone-950 text-white flex flex-col items-center py-5">
          ...
          <li
            className="py-2 transition-all duration-300 hover:text-yellow-500 hover:scale-110 hover:underline"
            onClick={closeMenu}
          >
            Projects
          </li>
